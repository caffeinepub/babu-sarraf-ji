...
export class Backend implements backendInterface {
    ...
    async getBackground(): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getBackground();
    ...
    async removeBackground(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.removeBackground();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveBackground(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveBackground(await to_candid_ExternalBlob_n10(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DailyTask]): DailyTask | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        subCategory: record_opt_to_undefined(from_candid_opt_n19(_uploadFile, _downloadFile, value.subCategory)),
        exam: value.exam,
        score: value.score,
